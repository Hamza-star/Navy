...
//       metrics = {
//         ...metrics,
//         onDurationMinutes: this.formulas.calculateOnDuration(data),
//       };
//     }
...
//     charts.CurrentImbalanceNeutral = data.map((d) => {
//       return {
//         time: this.formulas.formatTimeForResponse(d.timestamp),
...
//     charts.phaseBalanceEffectiveness = data.map((d) => ({
//       time: this.formulas.formatTimeForResponse(d.timestamp),
//       Genset_L1_Current: d.Genset_L1_Current,
//       Genset_L2_Current: d.Genset_L2_Current,
//       Genset_L3_Current: d.Genset_L3_Current,
//     }));

//     charts.voltageQualitySymmetry = data.map((d) => ({
//       time: this.formulas.formatTimeForResponse(d.timestamp),
//       Genset_L1L2_Voltage: d.Genset_L1L2_Voltage,
//       Genset_L2L3_Voltage: d.Genset_L2L3_Voltage,
//       Genset_L3L1_Voltage: d.Genset_L3L1_Voltage,
...
//       PowerLossFactor: d.Genset_Total_Power_Factor_calculated,
...
//           switch (field) {
//             case 'LoadPercent':
//               entry[field] = this.formulas.calculateLoadPercent(d);
//               break;
//             case 'PowerLossFactor':
//               entry[field] = this.formulas.calculatePowerLossFactor(d);
//               break;
//             case 'I2':
//               entry[field] = this.formulas.calculateThermalStress(d);
//               break;
//             default:
//               entry[field] = d[field];
//           }
